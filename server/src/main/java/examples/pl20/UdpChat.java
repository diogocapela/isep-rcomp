...
class UdpChat {
    ...
    private static HashSet<InetAddress> peersList = new HashSet<InetAddress>();
...
class UdpChatReceive implements Runnable {
    ...
    public UdpChatReceive(DatagramSocket udp_s) {
        s = udp_s;
    }
    ...
    public void run() {
        ...
        while (true) {
            ...
            if (data[0] == 1) { // peer start
                ...
                System.out.println(currPeerAddress + frase);
            }
        }
    }
}
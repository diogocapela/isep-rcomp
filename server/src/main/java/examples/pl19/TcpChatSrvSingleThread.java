...
class TcpChatSrvSingleThread {
    ...
    private static HashMap<Socket, DataOutputStream> cliListOut = new HashMap<Socket, DataOutputStream>();
    private static HashMap<Socket, DataInputStream> cliListIn = new HashMap<Socket, DataInputStream>();
